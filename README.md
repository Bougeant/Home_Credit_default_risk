...
For example, the figure below shows the impact of the education level of the customers on the target variable (average default rate) as well as the distribution of customers by education level.
...
<p align="center"><img src="./images/Stacked_ROC_AUC.png"></p>
